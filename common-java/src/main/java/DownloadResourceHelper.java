...
//        this.cookieStore = new BasicCookieStore();
        ...
        this.httpClient = HttpClients.custom()
                ...
                //.setProxy(new HttpHost("10.1.1.55", 8080))
     ...
     * Currently used Apache's LocalStore.
     *
     * @param name
     * @return
     */
    ...
    public void downloadResourceLoinc(String fileUrl, String defaultFileName) throws IOException {
        String url = fileUrl;
    ...
    public static void main(String[] args) throws IOException {
        ...
        downloadHelper.downloadResourceLoinc(fileUrl, defaultFileName);

         // Download 'Multiaxial Hierarchy' package
        System.out.println("\nDownload Multiaxial Hierarchy...");
        ...
        System.out.println("\nDownload CT Expression Association...");
