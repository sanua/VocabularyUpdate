...
;
--!!!give the code to the medical coder
select * from MANUAL_table
;
!!!Stop sctipt - give the result to medical coder who will fill concept_relationship_manual based on MANUAL_table--, remember concept_relatopnshoip_stage is empty for now
