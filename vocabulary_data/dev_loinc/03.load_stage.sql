...
PROMPT 3. Create concept_stage from LOINC
...
PROMPT 4 Load classes from loinc_class directly into concept_stage
INSERT INTO concept_stage SELECT * FROM loinc_class;
COMMIT;

--5 Add LOINC hierarchy
PROMPT 5 Add LOINC hierarchy
INSERT INTO concept_stage (concept_id,
                           concept_name,
                           domain_id,
                           vocabulary_id,
...
PROMPT 6 Add concept_relationship_stage link to multiaxial hierarchy
...
PROMPT 7 Add concept_relationship_stage to LOINC Classes inside the Class table. Create a 'Subsumes' relationship
INSERT INTO concept_relationship_stage (concept_id_1,
                                        concept_id_2,
                                        concept_code_1,
                                        concept_code_2,
...
PROMPT 8 Add concept_relationship between LOINC and LOINC classes from LOINC
INSERT INTO concept_relationship_stage (concept_id_1,
                                        concept_id_2,
                                        concept_code_1,
                                        concept_code_2,
...
PROMPT 9 Create CONCEPT_SYNONYM_STAGE
...
PROMPT 10 Adding Loinc Answer codes
INSERT INTO concept_stage (concept_id,
                           concept_name,
                           domain_id,
                           vocabulary_id,
...
PROMPT 11 Link LOINCs to Answers in concept_relationship_stage
INSERT INTO concept_relationship_stage (concept_id_1,
                                        concept_id_2,
                                        concept_code_1,
                                        concept_code_2,
...
PROMPT 12 Link LOINCs to Forms in concept_relationship_stage
INSERT INTO concept_relationship_stage (concept_id_1,
                                        concept_id_2,
                                        concept_code_1,
                                        concept_code_2,
...
PROMPT 13 Add LOINC to SNOMED map
...
PROMPT 14 Add LOINC to CPT map
INSERT /*+ APPEND */
...
PROMPT 15 Add replacement relationships
INSERT /*+ APPEND */ INTO  concept_relationship_stage (concept_code_1,
                                        concept_code_2,
                                        vocabulary_id_1,
                                        vocabulary_id_2,
...
PROMPT 16 Working with replacement mappings
BEGIN
...
PROMPT 17 Deprecate 'Maps to' mappings to deprecated and upgraded concepts
BEGIN
...
PROMPT 18 Add mapping from deprecated to fresh concepts
BEGIN
...
PROMPT 19 Delete ambiguous 'Maps to' mappings
BEGIN
...
PROMPT 20 Set the proper concept_class_id for children of "Document ontology" (AVOF-352)
...
PROMPT the end, the three tables concept_stage, concept_relationship_stage and concept_synonym_stage should be ready to be fed into the generic_update.sql script
