...
-- Perform CONCEPT_ANCESTOR checks
PROMPT Perform "get summary" for CONCEPT_ANCESTOR...
...
-- Count of inserted recods
PROMPT Count of inserted recods...
SELECT COUNT(1) AS 'Total records', 'MRCONSO' AS 'Name' FROM MRCONSO 
UNION ALL
SELECT COUNT(1), 'MRHIER' FROM MRHIER
UNION ALL
SELECT COUNT(1), 'MRMAP' FROM MRMAP
UNION ALL
SELECT COUNT(1), 'MRSAT' FROM MRSAT
UNION ALL
SELECT COUNT(1), 'MRSMAP' FROM MRSMAP;
